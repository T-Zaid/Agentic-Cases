...
from cases.shoe_store_case.tools import add_to_cart, generate_receipt, get_cart_total, get_product_info, lookup_order, modify_cart_item, view_cart
...
ShoeStoreAgent = RealtimeAgent[UserContext](
    name="ShoeStoreAgent",
    instructions="""
...
class NoUIDemo:
    ...
    async def run(self) -> None:
        ...
        try:
            runner = RealtimeRunner(ShoeStoreAgent)
